            ...
            <div class="main">
                <table cellspacing='0'>
                    <tr>
                        ...
                        <td width="80%"><input type="text" maxlength="10" autocomplete="false" class="uname" ref="uname" placeholder="必填"></td>
                    </tr>
                    <tr>
                        <td width="20%">手机号码</td>
                        <td width="80%"><input type="text"  maxlength="11" autocomplete="false" class="phone" ref="phone" placeholder="必填"></td>
                    </tr>
                    <tr>
                        <td width="20%">所在地区</td>
                        <td width="80%">
                            <input type="text" id="txt_area" class="area" v-on:focus="areaShow" v-model='areaMsg' readonly ref="area" placeholder="必填">
                        </td>
                    </tr>
                    <tr>
                        <td width="20%">详细地址</td>
                        <td width="80%"><input type="text" maxlength="50" autocomplete="false" class="address" ref="address" placeholder="必填"></td>
                    </tr>
                    <tr>
                        <td width="20%">邮政编码</td>
                        <td width="80%"><input type="text" maxlength="6" autocomplete="false" class="code" ref="code" ></td>
                    </tr>
                    <tr>
                        <td colspan='2'>
                            <checkBox ref="cbadd" value="01"  class="left"></checkBox>
                            <input type="hidden" value="01"/><span class="left" style="height:20px;line-height:20px;margin-left:3px;">设置为默认收件地址</span>
                        </td>
                    </tr>
            ...
            methods:{
                save(){
                    ...
                    if(userName == ""){
                        ...
                        return;
                    }else if(!_this.phoneTh){
                        _this.openAlert("请填写手机号码!");
                        return;
                    }else if(_this.prov1()){
                        if(area == ""){
