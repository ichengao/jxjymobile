	...
	<div v-title data-title="登录" class="main_box">
		...
		<div class="main" ref="main">
			...
			<div class="login_box">
				...
				<input type="text" ref="pwd" class="pwd insert" placeholder='请输入密码' v-on:keyup='setLoginStatus' v-on:focus='pwdGetFocus'>
				<p class="next_link">
...
<style scoped>
	...
	.logo_box{text-align: center;padding-top: 0.6rem;}
	.logo1{width:3.2rem;margin:0.4rem auto 0 auto;}
	.logo2{width:6.18rem;margin-top:0.35rem;}
	.login_box{padding:0 0.54rem;}
	.insert{width:100%;border:1px solid #e8e8e8;padding-top:0.23rem;padding-bottom:0.23rem;border-radius: 3px;-webkit-border-radius: 3px;-moz-border-radius: 3px;-o-border-radius: 3px;padding-left: 0.8rem;font-size: 0.3rem;}
	...
	.login.hover{background: -webkit-linear-gradient(left, #2cbbe5, #3c9ed1);background: -o-linear-gradient(left, #2cbbe5, #3c9ed1);background: linear-gradient(to right, #2cbbe5, #3c9ed1);}
</style>