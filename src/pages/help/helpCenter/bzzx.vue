		...
		<div class="main" ref='main'>
            <table>
                <tr>
                    ...
                    <td class="m_nav"><router-link :to="{path:'/helpType',query:{'codeNo':'151102'}}"><a>网站功能</a></router-link></td>
                </tr>
                <tr>
                    <td class="m_img"><img src="static/images/222_03.png" alt="安徽继续教育网"></td>
...
<style scoped>
	.header{width:100%;height:.9rem;background:url(../../../../static/images/bj-25.jpg) no-repeat;position:fixed;top:0;text-align: center}
    .header .back{position: absolute;top:16px;left:3%;}
    .header p{line-height:.9rem;color:#fff;font-size: 1.1em;}

    .main{margin:0 auto;padding:.9rem 5px 0 5px;background:#fff;}
    table{width:100%;border-collapse: collapse;}
    table td{padding:10px 0;border-bottom: 1px solid #C8C7C7}
    table td a{color:#7A7B7B;float: left;width:100%;}
    table td.m_img{width:0.2rem;padding-left: 5px;}
    table td{height:1rem;vertical-align: middle;}
