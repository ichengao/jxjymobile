<template>
	<div v-title data-title="注册协议">
		<!-- 头部 -->
		<heade :titlehead="headTitle"></heade>

		<div class="main">
            <h4 align="center">安徽继续教育网用户注册服务协议</h4>
            ...
            <p>
                ...
                （八）保护用户隐私是安徽继续教育网的一项基本政策，安徽继续教育网保证不对外公开或向第三方提供单个用户的注册资料及用户在使用网络服务时存储在安徽继续教育网的非公开内容，但下列情况除外：事先获得用户的明确授权；根据有关的法律法规要求；按照相关政府主管部门的要求；为维护社会公众的利益；为维护安徽继续教育网的合法权益。<br/>
                <br/>二、用户的权利和义务<br/>
                ...
                （十四）直到您发出订单，我们才能确认商品的价格。尽管我们做出最大的努力，我们的商品目录里的一小部分商品可能会有定价错误。如果我们发现错误定价，我们将采取下列之一措施：1)如果某一商品的正确定价低于我们的错误定价，我们将按照较低的定价向您销售交付该商品。2)如果某一商品的正确定价高于我们的错误定价，我们会根据我们的情况决定,是否在交付前联系您寻求您的指示, 或者取消订单、停止发货并通知您。<br/>
                <br/>三、免责声明<br/>
